...
Using now the full Go package qualifiers to avoid any ambiguity, the Filecoin block, `github.com/xianleigirl/lotus/chain/types.FullBlock`, is defined as,
...
#  https://github.com/xianleigirl/lotus/issues/1827
```
