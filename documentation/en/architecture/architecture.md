...
The majority of the sync functionality happens in the [`Syncer`](https://github.com/xianleigirl/lotus/blob/master/chain/sync.go),
internally managed by a [`SyncManager`](https://github.com/xianleigirl/lotus/blob/master/chain/sync_manager.go).
...
with the new peer through [the `hello` protocol](https://github.com/xianleigirl/lotus/blob/master/node/hello/hello.go).
...
and stored in a [`BadBlockCache`](https://github.com/xianleigirl/lotus/blob/master/chain/badtscache.go).
...
[`ChainStore`](https://github.com/xianleigirl/lotus/blob/master/chain/store/store.go).
...
encapsulated in the [`StateTree`](https://github.com/xianleigirl/lotus/blob/master/chain/state/statetree.go),
and accessed through the
[`StateManager`](https://github.com/xianleigirl/lotus/blob/master/chain/stmgr/stmgr.go).
...
[`MessageReceipt`](https://github.com/xianleigirl/lotus/blob/master/chain/types/message_receipt.go)
 and some
other information.
...
The [Lotus Virtual Machine](https://github.com/xianleigirl/lotus/blob/master/chain/vm/vm.go)
...
The `send()` method creates a [`Runtime`](https://github.com/xianleigirl/lotus/blob/master/chain/vm/runtime.go)
...
[`invoker`](https://github.com/xianleigirl/lotus/blob/master/chain/vm/invoker.go) structure.
...
the serialized response and the [`ActorError`](https://github.com/xianleigirl/lotus/blob/master/chain/actors/aerrors/error.go).
...
(see [here](https://github.com/xianleigirl/lotus/blob/master/cmd/lotus/daemon.go) for more),
...
(many defined in [`node/modules/dtypes/`](https://github.com/xianleigirl/lotus/tree/master/node/modules/dtypes)),
...
[`ChainStore`](https://github.com/xianleigirl/lotus/blob/master/chain/store/store.go) structure.
It takes as one of its parameters the [`ChainBlockstore`](https://github.com/xianleigirl/lotus/blob/master/node/modules/dtypes/storage.go)
...
Lotus creates this interface from a [Badger DB](https://github.com/dgraph-io/badger) in
 [`FsRepo`](https://github.com/xianleigirl/lotus/blob/master/node/repo/fsrepo.go).
...
The [`Blockstore` interface](`github.com/xianleigirl/lotus/blockstore/blockstore.go`) structures the key-value pair
...
`modules.ChainStore()` creates the [`store.ChainStore`](https://github.com/xianleigirl/lotus/blob/master/chain/store/store.go))
